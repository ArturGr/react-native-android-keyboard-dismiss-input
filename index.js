...
import { requireNativeComponent, ViewPropTypes, TouchableWithoutFeedback, UIManager, ColorPropType, EventEmitter, NativeMethodsMixin, Platform, StyleSheet, Text } from 'react-native';
...
if (Platform.OS === 'android') {
  var AndroidCustomTextInput = requireNativeComponent('AndroidCustomTextInput', null);
        ...
        for (var propKey in onlyMultiline) {
          if (props[propKey]) {
            const error = new Error(
              'CustomTextInput prop `' + propKey + '` is only supported with multiline.'
            );
...
_renderAndroid: function() {
  ...
  props.autoCapitalize =
    UIManager.AndroidCustomTextInput.Constants.AutoCapitalizationType[
